...
export const ASSETS = {
  ...
  wallHorizontal: asset("environment/walls/wall_horizontal.png"),
  wallVertical: asset("environment/walls/wall_vertical.png"),
  ...
  wallRibbedHorizontal: asset("environment/walls/wall_ribbed.png"),
  wallRibbedVertical: asset("environment/walls/wall_ribbed_vertical.png"),
  wallDamagedHorizontal: asset("environment/walls/wall_damaged.png"),
  wallDamagedVertical: asset("environment/walls/wall_damaged_vertical.png"),
  wallBrokenHorizontal: asset("environment/walls/wall_broken_horizontal.png"),
  wallBrokenVertical: asset("environment/walls/wall_broken_horizontal_rot90.png"),
  wallCorner: asset("environment/walls/corner.png"),
  wallCorner90: asset("environment/walls/wall_corner_90.png"),
  wallCorner90Rot90: asset("environment/walls/wall_corner_90_rot90.png"),
  wallCorner90Rot180: asset("environment/walls/wall_corner_90_rot180.png"),
  wallCorner90Rot270: asset("environment/walls/wall_corner_90_rot270.png"),
  wallBendWN: asset("environment/walls/wall_bend_W_NE.png"),
  wallBendWNRot90: asset("environment/walls/wall_bend_W_NE_rot90.png"),
  wallBendWNRot180: asset("environment/walls/wall_bend_W_NE_rot180.png"),
  wallBendWNRot270: asset("environment/walls/wall_bend_W_NE_rot270.png"),
  wallEndCap: asset("environment/walls/wall_end_cap.png"),
  wallJunctionT: asset("environment/walls/wall_junction_T.png"),
  wallJunctionY: asset("environment/walls/wall_junction_Y.png"),
  wallJunctionX: asset("environment/walls/wall_junction_diagonal_X.png"),
  doorOpenHorizontal: asset("environment/doors/door_open.png"),
  doorOpenVertical: asset("environment/doors/door_open_vertical.png"),
  doorClosedHorizontal: asset("environment/doors/door_closed.png"),
  doorClosedVertical: asset("environment/doors/door_closed_vertical.png"),
  pedestal: asset("scenery/control/pedestal.png"),
...
export const SCENERY_ASSETS = {
  ...
  analyzer: asset("scenery/lab/analyzer.png"),
  ...
  pipeValve: asset("scenery/lab/pipe_valve.png"),
  pipeElbow: asset("scenery/lab/pipe_elbow.png"),
  coiledCables: asset("scenery/lab/coiled_cables.png"),
  ...
  conduitJunction: asset("scenery/control/conduit_junction.png"),
  powerCabinet: asset("scenery/control/power_cabinet.png"),
  floorCables: asset("scenery/control/floor_cables.png"),
  reactorPylon: asset("scenery/arena/reactor_pylon.png"),
  coolantPump: asset("scenery/arena/coolant_pump.png"),
  ...
  pipeManifold: asset("scenery/arena/pipe_manifold.png"),
  damagedFuseCabinet: asset("scenery/arena/damaged_fuse_cabinet.png"),
  cableTrunk: asset("scenery/arena/cable_trunk.png"),
