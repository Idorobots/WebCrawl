...
export const BARREL_EXPLOSION_RADIUS = world(115);
...
interface MonsterDefinition {
  ...
  attackCooldownVarianceMs?: number;
...
export const REGULAR_MONSTER_DEFINITIONS: Record<RegularMonsterKind, MonsterDefinition> = {
  "melee-heavy": {
    kind: "melee-heavy",
    visualKinds: ["heavy"],
    attackPattern: "melee",
    ...
    hpVariance: 5,
    speed: world(70),
    speedPerDifficulty: world(6),
    maxSpeedBonus: world(60),
    attackRange: world(42),
    attackRangePerDifficulty: world(2),
    maxAttackRangeBonus: world(24),
    attackDamage: 3,
    attackCooldownMs: 1_250,
    cooldownReductionPerDifficulty: 25,
    minAttackCooldownMs: 700,
    projectileSpeed: 0,
  ...
  "melee-light": {
    ...
    hpVariance: 3,
    speed: world(170),
    speedPerDifficulty: world(10),
    maxSpeedBonus: world(90),
    attackRange: world(36),
    attackRangePerDifficulty: world(3),
    maxAttackRangeBonus: world(32),
    attackDamage: 1,
    attackCooldownMs: 700,
    cooldownReductionPerDifficulty: 20,
    minAttackCooldownMs: 400,
    projectileSpeed: 0,
    projectileSpeedPerDifficulty: 0,
    maxProjectileSpeedBonus: 0,
    projectileRange: 0,
  ...
  "shooter-light": {
    ...
    maxSpeedBonus: world(70),
    attackRange: world(420),
    attackRangePerDifficulty: world(10),
    maxAttackRangeBonus: world(100),
    attackDamage: 1,
    attackCooldownMs: 520,
    cooldownReductionPerDifficulty: 15,
    minAttackCooldownMs: 300,
    projectileSpeed: world(280),
    projectileSpeedPerDifficulty: world(12),
    maxProjectileSpeedBonus: world(150),
    projectileRange: world(560),
  ...
  "shooter-heavy": {
    ...
    hpVariance: 5,
    speed: world(70),
    speedPerDifficulty: world(5),
    maxSpeedBonus: world(50),
    attackRange: world(480),
    attackRangePerDifficulty: world(10),
    maxAttackRangeBonus: world(100),
    attackDamage: 3,
    attackCooldownMs: 1_500,
    cooldownReductionPerDifficulty: 30,
    minAttackCooldownMs: 900,
    projectileSpeed: world(230),
    projectileSpeedPerDifficulty: world(10),
    maxProjectileSpeedBonus: world(120),
    projectileRange: world(650),
    projectileRangePerDifficulty: world(22),
    maxProjectileRangeBonus: world(200),
  },
  "sentry-light": {
    kind: "sentry-light",
    ...
    maxSpeedBonus: 0,
    attackRange: world(700),
    attackRangePerDifficulty: 0,
    maxAttackRangeBonus: 0,
    attackDamage: 1,
    attackCooldownMs: 400,
    attackCooldownVarianceMs: 0,
    cooldownReductionPerDifficulty: 0,
    minAttackCooldownMs: 400,
    projectileSpeed: world(250),
    projectileSpeedPerDifficulty: world(12),
    maxProjectileSpeedBonus: world(150),
    projectileRange: world(760),
    projectileRangePerDifficulty: world(20),
    maxProjectileRangeBonus: world(180),
  },
  "sentry-heavy": {
    ...
    speedPerDifficulty: 0,
    maxSpeedBonus: 0,
    attackRange: world(760),
    attackRangePerDifficulty: 0,
    maxAttackRangeBonus: 0,
    attackDamage: 1,
    attackCooldownMs: 850,
    cooldownReductionPerDifficulty: 12,
    minAttackCooldownMs: 600,
    projectileSpeed: world(300),
    projectileSpeedPerDifficulty: world(12),
    maxProjectileSpeedBonus: world(150),
    projectileRange: world(820),
    projectileRangePerDifficulty: world(20),
    maxProjectileRangeBonus: world(180),
  },
  "sentry-scatter": {
    ...
    speedPerDifficulty: 0,
    maxSpeedBonus: 0,
    attackRange: world(620),
    attackRangePerDifficulty: 0,
    maxAttackRangeBonus: 0,
    attackDamage: 2,
    attackCooldownMs: 1_600,
    cooldownReductionPerDifficulty: 20,
    minAttackCooldownMs: 1_100,
    projectileSpeed: world(240),
    projectileSpeedPerDifficulty: world(10),
    maxProjectileSpeedBonus: world(120),
    projectileRange: world(700),
...
export const MINIBOSS_SIZE_MULTIPLIER = 1.4;
...
export const BOSS_DEFINITIONS: Record<BossKind, BossDefinition> = {
  ...
  "kimi-swarm": {
    ...
    speed: world(68),
    speedPerDifficulty: world(3),
    maxSpeedBonus: world(40),
    attackRange: world(72),
    attackDamage: 2,
    attackDamageDifficultyDivisor: 3,
    attackCooldownMs: 1_300,
    cooldownReductionPerDifficulty: 50,
    minAttackCooldownMs: 700,
    projectileSpeed: world(220),
    projectileSpeedPerDifficulty: world(14),
    projectileRange: world(950),
  },
  "llama-herd": {
    kind: "llama-herd",
    ...
    speed: world(56),
    speedPerDifficulty: world(3),
    maxSpeedBonus: world(46),
    attackRange: world(74),
    attackDamage: 3,
    attackDamageDifficultyDivisor: 3,
    attackCooldownMs: 1_450,
    cooldownReductionPerDifficulty: 45,
    minAttackCooldownMs: 700,
    projectileSpeed: world(200),
    projectileSpeedPerDifficulty: world(12),
