...
const NAME_PREFIXES = [
  "QUANTIZED", "JAILBROKEN", "RED-TEAM", "UNHINGED", "FINETUNED", "OVERFIT",
  "DISTILLED", "SELF-HOSTED", "HALLUCINATING", "GREPPY", "VIBE-CODED",
  "AUTOREGRESSIVE", "LOSSLESS", "STOCHASTIC", "PRUNED", "MORALLY",
] as const;
